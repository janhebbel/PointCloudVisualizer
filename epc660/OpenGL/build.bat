...
REM Debug Build
echo Debug Build
cl %compile_flags% /MT /Od /Z7 /DDEBUG /D_CRT_SECURE_NO_WARNINGS /Fe"debug" %files% /link %linker_flags%

REM Release Build
echo Release Build
cl %compile_flags% /MT /O2 /DRELEASE /D_CRT_SECURE_NO_WARNINGS /Fe"release" %files% /link %linker_flags%
