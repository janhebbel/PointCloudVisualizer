...
echo Debug
cl %compile_flags% /MT /Od /Zi /D "DEBUG" /D "_DEBUG" /Fe"debug" %files% /link %linker_flags%

echo:

echo Release With Debug Symbols
cl %compile_flags% /MT /O2 /Zi /D "RELEASE" /D "NDEBUG" /Fe"release_with_debug_info" %files% /link %linker_flags%
